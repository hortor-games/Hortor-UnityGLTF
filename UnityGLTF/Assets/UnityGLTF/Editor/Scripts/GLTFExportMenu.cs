...
public class GLTFExportMenu : EditorWindow
{
    ...
    void OnGUI()
    {
        ...
        EditorGUILayout.HelpBox("Supported extensions: KHR_material_pbrSpecularGlossiness, KHR_texture_transform, KHR_materials_common, FB_materials_modmap", MessageType.Info);
    }
